...
(function () {
  ...
  const LAYOUTS = {
    ...
    punjabi: {
      name: 'ਪੰਜਾਬੀ',
      normal: [['ੌ','੧','੨','੩','੪','੫','੬','੭','੮','੯','੦','-','ੁ','←'],['ੌ','ੈ','ਾ','ੀ','ੂ','ਬ','ਹ','ਗ','ਦ','ਜ','ਡ','਼'],['ੋ','ੇ','੍','ਿ','ੁ','ਪ','ਰ','ਕ','ਤ','ਚ','ਟ','Enter'],['Shift','ਂ','ਮ','ਨ','ਵ','ਲ','ਸ',',','.','ਯ','Shift'],['Space']],
      shift:  [['ਔ','ਐ','ਆ','ਈ','ਊ','ਭ','ਃ','ਘ','ਧ','ਝ','ਢ','←'],['ਓ','ਏ','ਅ','ਇ','ਉ','ਫ','ੜ','ਖ','ਥ','ਛ','ਠ','Enter'],['Shift','ਁ','ਮ','ਣ','ਵ','ਲ਼','ਸ਼','ਖ਼','।','ਯ','Shift'],['Space']]
    },
    kannada: {
      name: 'ಕನ್ನಡ',
      normal: [['ೊ','೧','೨','೩','೪','೫','೬','೭','೮','೯','೦','-','ೃ','←'],['ೌ','ೈ','ಾ','ೀ','ೂ','ಬ','ಹ','ಗ','ದ','ಜ','ಡ','಼'],['ೋ','ೇ','್','ಿ','ು','ಪ','ರ','ಕ','ತ','ಚ','ಟ','Enter'],['Shift','ಂ','ಮ','ನ','ವ','ಲ','ಸ',',','.','ಯ','Shift'],['Space']],
      shift:  [['ಒ','ಎ','ಏ','ರ್','ಜ್ಞ','ತ್ರ','ಕ್ಷ','ಶ್ರ','(','(','ಃ','ಋ','←'],['ಔ','ಐ','ಆ','ಈ','ಊ','ಭ','ಙ','ಘ','ಧ','ಝ','ಢ'],['ಓ','ಏ','ಅ','ಇ','ಉ','ಫ','ಱ','ಖ','ಥ','ಛ','ಠ','Enter'],['Shift','ಁ','ಮ','ಣ','ವ','ಳ','ಶ','ಷ','।','ಯ','Shift'],['Space']]
    }
  };
